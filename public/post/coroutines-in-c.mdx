...
![Preemptive multitasking is managed by the kernel, and cooperative multitasking is managed by the tasks themselves](/pic/coroutines/multitasking-types.svg)
...
![Drawing of the table in a beautifull picture](/pic/coroutines/stack.svg)
...
![stack before ret](/pic/coroutines/stack2.svg)
